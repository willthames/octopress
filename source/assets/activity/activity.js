...
function summaryData(json) { 
    ...
    var summary = d3.select("#training").append("table")
...
function title(json) { 
    var titleh1 = d3.select("#training").append("h1")
...
function activity_to_geojson(json) { 
    var points = [];
...
function drawMap(json) { 
    ...
    var geojson = activity_to_geojson(json);

    var bounds = d3.geo.bounds(geojson),
        path = d3.geo.path().projection(project),
        centerX = (+json.summary.nec_lng + +json.summary.swc_lng)/2.0,
        centerY = (+json.summary.nec_lat + +json.summary.swc_lat)/2.0;
    ...
    var feature = g.selectAll(".bobbins")
        .data(geojson)
